...
public class IdentificaTokenTest {
	...
	public void testaIdentificador(){
		...
		assertEquals(msgCod + 19, 19, this.id.identifica("variavel").getOrdinal());
	...
	public void testaInteiro(){
		...
		assertEquals(msgCod + 20, 20, this.id.identifica("15").getOrdinal());
	...
	public void testeComentario(){
		...
		assertEquals(msgCod + 46, 46, this.id.identifica("(**)").getOrdinal());
	}
